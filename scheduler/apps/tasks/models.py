...
class Task(models.Model):
    ...
    created_by = models.ForeignKey(User, default=0, related_name='task', on_delete=models.SET_DEFAULT)
    assigned_to = models.ManyToManyField(User, related_name='developer', blank=True)  
